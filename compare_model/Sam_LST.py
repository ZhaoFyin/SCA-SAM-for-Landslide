from .sam_lst import sam_model_registry
import torch
...
class SAM_LST(nn.Module):
    def __init__(self, num_classes, input_size=224):
        ...
        self.sam, img_embedding_size = sam_model_registry["vit_b"](image_size=input_size,
                                                                   num_classes=num_classes,
                                                                   checkpoint="./cp/sam_vit_b_01ec64.pth",
...
if __name__ == "__main__":
    ...
    net = SAM_LST().cuda()
    out = net(torch.rand(2, 3, 512, 512).cuda(), None, 512)
    parameter = 0
    select = 0
